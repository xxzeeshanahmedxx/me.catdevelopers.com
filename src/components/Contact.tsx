...
const socials: Social[] = [
  ...
  {
    name: 'Email',
    url: 'mailto:hi@catdevelopers.com',
...
export default function Contact() {
  return (
    <section id="contact" className="px-4 sm:px-6 py-20 sm:py-28">
      <div className="max-w-lg mx-auto text-center">
        <p className="section-label">Connect</p>
        <h2 className="section-heading text-[clamp(1.75rem,4vw,2.75rem)] mt-2">Find Me</h2>
        <p className="section-subheading mx-auto mt-3">Where to find me around the web</p>
        ...
        <div className="flex items-center justify-center gap-6 mt-10">
          {socials.map((social) => (
            <a
              ...
              className="flex items-center gap-2 text-ink-muted hover:text-accent transition-colors duration-200"
              title={social.name}
            >
              {social.icon}
        ...
        <p className="text-[11px] text-ink-disabled mt-12">
          Built by Zeeshan &middot; 2026
        </p>
      </div>
    </section>
  );
